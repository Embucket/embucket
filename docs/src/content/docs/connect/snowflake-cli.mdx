...
<Aside type="tip">
For production workloads, deploy Embucket on AWS Lambda. See [AWS Lambda deployment](/deploy/aws-lambda/) for instructions.
</Aside>
...
| No data returned | Configure a metastore so Embucket can access your data. See [Configuration](/deploy/configuration/) for details. |
