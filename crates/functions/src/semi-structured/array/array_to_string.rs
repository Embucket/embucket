    ...
    ('[true, 1, -1.2e-3, "Abc", ["x","y"], {"a":{"b":"c"},"c":1,"d":[1,2,"3"]}]')"#;
        ...
        assert_batches_eq!(
            &[
                ...
                "| [1]                                                                       | 1                                                           | 1                                                                     |",
                "| [1, 2]                                                                    | 12                                                          | 1, 2                                                                  |",
                "| [true, 1, -1.2e-3, \"Abc\", [\"x\",\"y\"], { \"a\":1 }]                           | true1-1.2e-3Abc[\"x\",\"y\"]{\"a\":1}                             | true, 1, -1.2e-3, Abc, [\"x\",\"y\"], {\"a\":1}                             |",
                "| [true, 1, -1.2e-3, \"Abc\", [\"x\",\"y\"], {\"a\":{\"b\":\"c\"},\"c\":1,\"d\":[1,2,\"3\"]}] | true1-1.2e-3Abc[\"x\",\"y\"]{\"a\":{\"b\":\"c\"},\"c\":1,\"d\":[1,2,\"3\"]} | true, 1, -1.2e-3, Abc, [\"x\",\"y\"], {\"a\":{\"b\":\"c\"},\"c\":1,\"d\":[1,2,\"3\"]} |",
                "+---------------------------------------------------------------------------+-------------------------------------------------------------+-----------------------------------------------------------------------+",
            ],
            &result
        );
