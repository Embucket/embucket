...
#[must_use]
pub fn server_default_cfg(data_format: &str) -> Option<(RestApiConfig, UtilsConfig)> {
    Some((
...
#[allow(clippy::expect_used)]
pub fn run_test_rest_api_server(server_cfg: Option<(RestApiConfig, UtilsConfig)>) -> SocketAddr {
